package com.cts.releasepilot.release.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.cts.releasepilot.release.service..*)")
    public void serviceLayer() {
    }

    @Pointcut("within(com.cts.releasepilot.release.controller..*)")
