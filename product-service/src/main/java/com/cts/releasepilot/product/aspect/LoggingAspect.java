package com.cts.releasepilot.product.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.cts.releasepilot.product.service..*)")
    public void serviceLayer() {
    }

    @Pointcut("within(com.cts.releasepilot.product.controller..*)")
