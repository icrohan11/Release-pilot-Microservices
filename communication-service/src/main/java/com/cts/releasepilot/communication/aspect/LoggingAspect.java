package com.cts.releasepilot.communication.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.cts.releasepilot.communication.service..*)")
    public void serviceLayer() {
    }

    @Pointcut("within(com.cts.releasepilot.communication.controller..*)")
