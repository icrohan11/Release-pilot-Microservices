package com.cts.releasepilot.backlog.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.cts.releasepilot.backlog.service..*)")
    public void serviceLayer() {
    }

    @Pointcut("within(com.cts.releasepilot.backlog.controller..*)")
